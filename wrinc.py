...
#_inception1(input,filter_size,kernel_num,is_train,global_step,name=basename):
        with tf.variable_scope('inception' ) as scope:
            inception=utils._inception1(conv3,[1,3,3,3],[128,64,128,64],self.is_train,self._global_step,name='inception')
        ...
        with tf.variable_scope('logits') as scope:
            ...
            dim_conv4=conv4_shape[1]*conv4_shape[2]*conv4_shape[3]
            x = tf.reshape(conv4, [conv4_shape[0],dim_conv4 ])
            #pdb.set_trace()
