...
class wrinc(object):
    ...
    def build_model(self):
        ...
        conv1 = utils._conv(self._images, 3, 16, 1, name='conv1')
        ...
        with tf.variable_scope('conv3' ) as scope:
        	conv3_1a_1_3x3=utils._basic_conv(conv2_res2_2_relu,3,128,2,self.is_train,self._global_step,name='conv3_1a_1_3x3')
        	conv3_1a_2_3x3=utils._conv(conv3_1a_1_3x3,3,128,1,name='conv3_1a_2_3x3')
        	conv3_1b_1x1=utils._conv(conv2_res2_2_relu,1,128,2,name='conv3_1b_1x1')
...
#_inception1(input,filter_size,kernel_num,is_train,global_step,name=basename):
        with tf.variable_scope('inception' ) as scope:
            inception=utils._inception1(conv3_res3_2a_relu,[1,3,3,3,1],[128,64,128,64,128],self.is_train,self._global_step,name='inception')
